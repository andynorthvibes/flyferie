...
const guides = ["christmas-markets", "hidden-gems", "thailand", "travel-gear", "car-rental", "esim", "cheap-flights", "airport-transfer", "weekend-packing-list", "travel-insurance"] as const;
