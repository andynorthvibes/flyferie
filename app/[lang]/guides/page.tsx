...
const guides = [
  ...
  { slug: "romantic-weekend", category: "plan", no: "Planlegg en romantisk weekendtur", en: "Plan a romantic weekend trip", noText: "Velg reisemål, hotell og opplevelser som gir god tid sammen.", enText: "Choose a destination, hotel and experiences that leave quality time together." },
  { slug: "solo-weekend-trip", category: "plan", no: "Weekendtur alene", en: "Solo weekend trip", noText: "Planlegg en trygg og fleksibel tur der du bestemmer tempoet selv.", enText: "Plan a safe and flexible trip where you set the pace yourself." },
  { slug: "weekend-trip-with-children", category: "plan", no: "Weekendtur med barn", en: "Weekend trip with children", noText: "Velg enkle reiser, praktisk hotell og et program med pauser.", enText: "Choose simple journeys, practical accommodation and a schedule with breaks." },
  ...
  { slug: "when-to-book-flights", category: "book", no: "Når bør du bestille flybilletter?", en: "When should you book flights?", noText: "Følg prisene, bruk prisvarsler og vurder når det er riktig å slå til.", enText: "Track fares, use price alerts and decide when it makes sense to book." },
  { slug: "choose-flight-times", category: "book", no: "Slik velger du gode flytider", en: "How to choose good flight times", noText: "Sammenlign avgang, ankomst, flyplass og den brukbare tiden på reisemålet.", enText: "Compare departure, arrival, airports and the usable time at your destination." },
  { slug: "direct-flight-or-connection", category: "book", no: "Direktefly eller mellomlanding?", en: "Direct flight or connection?", noText: "Vurder pris, reisetid, risiko og hvor mye av turen som forsvinner underveis.", enText: "Consider price, journey time, risk and how much of the trip is spent in transit." },
  { slug: "choose-hotel-area", category: "book", no: "Slik velger du riktig hotell og område", en: "How to choose the right hotel and area", noText: "Vurder beliggenhet, transport, romtype, vilkår og totalpris.", enText: "Consider location, transport, room type, conditions and total price." },
  { slug: "compare-hotel-prices", category: "book", no: "Slik sammenligner du hotellpriser", en: "How to compare hotel prices", noText: "Sammenlign samme rom, samme vilkår og den faktiske sluttprisen.", enText: "Compare the same room, the same conditions and the true final price." },
  { slug: "when-to-book-hotels", category: "book", no: "Når bør du bestille hotell?", en: "When should you book a hotel?", noText: "Følg pris og tilgjengelighet, vurder fleksibilitet og bestill når valget passer reisen.", enText: "Track price and availability, consider flexibility and book when the option suits your trip." },
  { slug: "flexible-hotel-booking", category: "book", no: "Fleksibel hotellbestilling og avbestilling", en: "Flexible hotel booking and cancellation", noText: "Forstå refunderbare priser, frister, forskuddsbetaling og vilkår før du bestiller.", enText: "Understand refundable rates, deadlines, prepayment and conditions before you book." },
  ...
  { slug: "cabin-bag-weekend", category: "prepare", no: "Weekendtur med håndbagasje", en: "A weekend trip with cabin baggage", noText: "Pakk lett, bruk plaggene flere ganger og kontroller reglene før avreise.", enText: "Pack light, rewear versatile clothing and check the rules before departure." },
  ...
  { slug: "international-travel-checklist", category: "prepare", no: "Sjekkliste før utenlandsreisen", en: "Checklist before international travel", noText: "Kontroller dokumenter, helse, betaling, mobil, transport og det praktiske hjemme.", enText: "Check documents, health, payments, mobile access, transport and practical tasks at home." },
