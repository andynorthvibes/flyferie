...
export const newDestinationGuides: Record<string, Guide> = {
  ...
  "phi-phi": guide({
    seo: ["Phi Phi-guide: strender, utsikt og øyhopping", "Phi Phi guide: beaches, viewpoints and island hopping"],
    intro: ["Phi Phi-øyene byr på turkise bukter, dramatiske kalksteinsklipper og et bilfritt øyliv midt i Andamanhavet. Mange kommer på dagstur, men noen netter på Phi Phi Don gir tidlige morgener, roligere kvelder og langt bedre tid til å oppleve øyene.", "The Phi Phi Islands combine turquoise bays, dramatic limestone cliffs and car-free island life in the Andaman Sea. Many arrive on a day trip, but staying a few nights on Phi Phi Don brings early mornings, quieter evenings and much more time to explore the islands."],
    bestFor: [["Øyhopping", "Island hopping"], ["Strand og snorkling", "Beaches and snorkelling"], ["Utsikt og natur", "Views and nature"], ["Par og venner", "Couples and friends"]],
    stay: ["2–4 netter", "2–4 nights"],
    areas: ["Tonsai Village, Loh Dalum, Long Beach og Laem Tong", "Tonsai Village, Loh Dalum, Long Beach and Laem Tong"],
    transport: ["Gange, longtailbåt og ferge", "Walking, long-tail boat and ferry"],
    airport: ["Phuket eller Krabi", "Phuket or Krabi"],
    weekend: [
      [["Første dag", "First day"], ["Tonsai og solnedgang", "Tonsai and sunset"], ["Ankom med ferge, finn dere til rette og bli kjent med stiene mellom Tonsai Bay og Loh Dalum. Avslutt dagen ved stranden eller et utsiktspunkt dersom tiden og dagslyset tillater det.", "Arrive by ferry, settle in and explore the paths between Tonsai Bay and Loh Dalum. Finish at the beach or a viewpoint if time and daylight allow."]],
      [["Andre dag", "Second day"], ["Phi Phi Leh og Maya Bay", "Phi Phi Leh and Maya Bay"], ["Dra tidlig med longtailbåt eller en liten gruppetur til Phi Phi Leh. Kombiner laguner, snorkling og Maya Bay når vær, sjøforhold og nasjonalparkregler gjør det mulig.", "Leave early by long-tail boat or small-group tour for Phi Phi Leh. Combine lagoons, snorkelling and Maya Bay when weather, sea conditions and national-park rules allow."]],
      [["Tredje dag", "Third day"], ["Utsikt og Long Beach", "Viewpoints and Long Beach"], ["Gå til Phi Phi Viewpoint før varmen blir sterk, og bruk resten av dagen på Long Beach eller en roligere bukt som nås til fots eller med båt.", "Walk to Phi Phi Viewpoint before the heat builds, then spend the rest of the day at Long Beach or a quieter bay reached on foot or by boat."]]
    ],
    districts: [["Tonsai Village", ["Mest praktisk ved bryggen, med størst utvalg av restauranter, butikker og båtturer.", "The most practical base near the pier, with the widest choice of restaurants, shops and boat trips."]], ["Loh Dalum", ["Strand, sosial stemning og mer liv på kveldstid.", "Beach access, a social atmosphere and livelier evenings."]], ["Long Beach", ["Roligere strandbase med utsikt mot Phi Phi Leh, men mindre praktisk bagasjetransport.", "A quieter beach base with views towards Phi Phi Leh, though luggage transfers are less convenient."]], ["Laem Tong", ["Avslappet resortområde nord på øya, vanligvis avhengig av båttransport.", "A relaxed resort area in the north, usually dependent on boat transfers."]]],
    tips: [[ ["Reis tidlig", "Travel early"], ["Tidlige båtturer gir ofte roligere bukter, mindre varme og bedre margin dersom været endrer seg.", "Early boat trips often mean quieter bays, cooler temperatures and more flexibility if conditions change."]], [["Sjekk parkreglene", "Check park rules"], ["Tilgang, badebestemmelser og sesongstenging kan endres i nasjonalparken. Kontroller reglene lokalt før avreise.", "Access, swimming rules and seasonal closures can change in the national park. Check current local guidance before departure."]], [["Pakk lett", "Pack light"], ["Phi Phi Don har ingen bilveier. Bagasje bæres, trilles eller fraktes med båt mellom bryggen og hotellet.", "Phi Phi Don has no roads for cars. Luggage is carried, wheeled or transferred by boat between the pier and your hotel."]]],
    transportUrl: "https://www.tourismthailand.org/Destinations/Provinces/Krabi/347", transportName: "Tourism Authority of Thailand"
  })
};
