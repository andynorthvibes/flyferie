...
const thailandSlugs = ["bangkok", "ao-nang", "phuket", "hua-hin", "koh-samui", "phi-phi"];
const thailandDestinationGuideSlugs = new Set(["phuket", "hua-hin", "koh-samui", "phi-phi"]);
        ...
        <div className="relative z-10 sm:absolute sm:bottom-0 sm:left-0 sm:right-0">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-px overflow-hidden rounded-t-[28px] bg-white/20 sm:grid-cols-3 lg:rounded-t-[34px]">
            {[
              ...
              [lang === "no" ? "Opplev Thailand" : "Discover Thailand", "Bangkok · Ao Nang · Phuket · Hua Hin · Koh Samui · Phi Phi", `/${lang}/guides/thailand`]
            ].map(([title, sub, href]) => (
      ...
      <section id="thailand" className="relative overflow-hidden bg-[#f4d7a1] px-5 py-12 text-[#17332f] lg:px-8 lg:py-14">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-[#365b55] sm:mt-5 sm:text-lg sm:leading-8">{lang === "no" ? "Thailand står for seg selv på Flyferie: storbyenergi i Bangkok, Krabis dramatiske natur og ulike strandferier i Ao Nang, Phuket, Hua Hin, Koh Samui og Phi Phi." : "Thailand has its own place on Flyferie: Bangkok's big-city energy, Krabi's dramatic nature and different beach holidays in Ao Nang, Phuket, Hua Hin, Koh Samui and Phi Phi."}</p>
