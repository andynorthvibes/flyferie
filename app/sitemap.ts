...
const guides = ["berlin-or-krakow", "christmas-markets", "hidden-gems", "thailand", "travel-gear", "international-travel-checklist", "car-rental", "esim", "cheap-flights", "when-to-book-flights", "choose-flight-times", "direct-flight-or-connection", "choose-hotel-area", "compare-hotel-prices", "when-to-book-hotels", "flexible-hotel-booking", "airport-transfer", "weekend-packing-list", "cabin-bag-weekend", "travel-insurance", "plan-weekend-trip", "choose-weekend-destination", "surprise-trip", "weekend-trip-budget", "hidden-travel-costs", "group-trip", "romantic-weekend", "solo-weekend-trip", "weekend-trip-with-children"] as const;
